...
module.exports = {
    name: "helpme",
    description: "List all of my commands, and maybe some info one.",
    aliases: ["gameshelp", "helpgames"],
    usage: "[command name]",
    cooldown: 5,
    execute(message, args) {
        ...
        return message.channel.send(data, { split: true }).catch(error => console.error(error));
    } 
};